...
def run_gdelt_ingestion(run_id: str, max_files: int = 17280, output_path: str = "/workspace/data/bronze", start_from_ts: int = None):
        ...
        while files_processed < max_files:
            ...
            try:
                ...
                if response.status_code == 200:                    
                    with zipfile.ZipFile(io.BytesIO(response.content)) as z:
                        with z.open(z.namelist()[0]) as f:
                            ...
                            if row_count > 0:
                                ...
                                # No AML data in this file, mark as skipped
                                meta.update_file_status(conn, DATASET, current_ts, 'skipped', error_message="No AML themes found")
                            # Always update watermark for successfully processed files
                    ...
                    # Check if we've reached the end (trying to download future data)
                    ...
                    if current_dt > datetime.now():
                        ...
                        # Historical file missing (gap in GDELT data) - skip and continue
                        ...
                        meta.update_watermark(conn, DATASET, current_ts, run_id)  # Update watermark to skip this gap
                else:
